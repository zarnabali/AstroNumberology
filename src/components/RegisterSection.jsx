...
import img1 from "../assets/logo/login_img2.png";
...
const RegisterSection = () => {
  ...
  const navigateToLogin = (e) => {
    e.preventDefault();
    navigate('/login'); // Use the specified route
  };
  ...
  return (
    ...
    >
      ...
      <div className="relative pt-16 md:pt-20 lg:pt-24 max-w-7xl mx-auto px-6 sm:px-16 z-10">
        ...
        <div className="absolute top-0 left-6 sm:left-16">
          <button 
            onClick={navigateToLogin}
            className="flex items-center text-white hover:text-[#dcb483] transition-colors duration-300"
          >
          ...
          <div className="flex flex-row items-start gap-5 w-full lg:w-1/2">
            ...
            <div ref={formRef} className="w-full">
              <h1 className="font-black text-white lg:text-[50px] sm:text-[40px] xs:text-[34px] text-[28px] lg:leading-[60px] mt-0">
                Begin Your <br className="sm:block hidden" />
                <span className="text-[#dcb483]">Cosmic Adventure</span>
              </h1>
              <p className="text-white font-medium lg:text-[18px] sm:text-[16px] xs:text-[15px] text-[14px] mt-2 mb-6 max-w-[500px]">
                Create your account to discover your personalized astro-numerology chart and stellar insights.
              </p>
              ...
              <form className="space-y-4 max-w-[450px]">
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="terms" className="ml-2 text-sm text-white">
                    I agree to the <a href="#" className="text-[#dcb483] hover:underline">Terms and Conditions</a> and <a href="#" className="text-[#dcb483] hover:underline">Privacy Policy</a>
                  </label>
                </div>
                ...
                <div className="relative flex items-center justify-center mt-8 mb-4">
                  ...
                  <div className="bg-[#111827] text-white px-4 relative z-10 text-sm">Or sign up with</div>
                </div>
                ...
                <p className="text-white text-sm text-center mt-6">
                  ...
                  <a href="/login" onClick={navigateToLogin} className="text-[#dcb483] ml-1 hover:underline">Sign In</a>
                </p>
              </form>
            </div>
          </div>
...
export default BasicWrapper(RegisterSection, 'register');